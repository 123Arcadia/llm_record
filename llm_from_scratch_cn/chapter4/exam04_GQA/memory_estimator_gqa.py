...
if __name__ == '__main__':
    main()
    # 命令:
    # python memory_estimator_gqa.py --emb_dim 4096 --n_heads 32 --n_layers 32 --context_length 32768 --n_kv_groups 4 --batch_size 1 --dtype bf16

    # 结果:
    # oups 4 --batch_size 1 --dtype bf16
    # ==== Config ====
